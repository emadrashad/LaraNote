...
const I18N = {
  ar: {
    ...
    data_management_hint: "نسخ احتياطي واستعادة الملاحظات والتمييزات الخاصة بك عبر الأجهزة.",
  ...
  en: {
    ...
    data_management_hint: "Backup and restore your notes and highlights across devices.",
